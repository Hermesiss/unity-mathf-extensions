...
namespace Trismegistus.MathfExtensions.Tests {
	public class MathfExtensionsTests {
		...
		public void ClosestPowerOfTwo() {
			Assert.True(Tester(MathfExtensions.ClosestPowerOfTwo,
		...
		public void IsPowerOfTwo() {
			Assert.True(Tester(MathfExtensions.IsPowerOfTwo,
				Mathf.IsPowerOfTwo,
				() => Random.Range(0, 10000)));
		}
		...
		public void NextPowerOfTwo() {
			Assert.True(Tester(MathfExtensions.NextPowerOfTwo,
		...
		public void GammaToLinearSpace() {
			Assert.True(Tester(MathfExtensions.GammaToLinearSpace,
		...
		public void LinearToGammaSpace() {
			Assert.True(Tester(MathfExtensions.LinearToGammaSpace,
		...
		public void CorrelatedColorTemperatureToRGB() {
			Assert.True(Tester(MathfExtensions.CorrelatedColorTemperatureToRGB,
		...
		public void FloatToHalf() {
			Assert.True(Tester(MathfExtensions.FloatToHalf,
				Mathf.FloatToHalf,
				() => Random.Range(0, 100f)));
		}
